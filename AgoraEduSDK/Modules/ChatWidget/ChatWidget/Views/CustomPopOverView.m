...
- (void)layoutSubviews
{
    ...
    self.imageView.bounds =CGRectMake(2,5,20,20);
    self.imageView.frame =CGRectMake(2,5,20,20);
    self.imageView.contentMode =UIViewContentModeScaleAspectFit;
    
    CGRect tmpFrame = self.textLabel.frame;
    tmpFrame.origin.x = 24;
    tmpFrame.size.width = self.contentView.bounds.size.width - 24;
...
- (void)updateSubViewFrames
{
    ...
    switch (_contentPosition) {
        ...
        case CPContentPositionAlwaysUp:
        {
            ...
            containerViewFrame.origin.y = CGRectGetMinY(newFrame) - self.style.showSpace - containerViewFrame.size.height+8;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (icon.length) {
        cell.imageView.image = [UIImage imageNamedFromBundle:icon];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.delegate respondsToSelector:@selector(popOverView:didClickMenuTitle:)]) {
        [self.delegate popOverView:self didClickMenuTitle:cell.textLabel.text];
    }
}
